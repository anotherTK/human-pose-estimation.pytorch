...
# ResNet
_C.MODEL.RESNET = CN()
_C.MODEL.RESNET.LAYERS = 50
_C.MODEL.RESNET.DECONV_WITH_BIAS = False
_C.MODEL.RESNET.NUM_DECONV_LAYERS = 3
_C.MODEL.RESNET.NUM_DECONV_FILTERS = [256, 256, 256]
_C.MODEL.RESNET.NUM_DECONV_KERNELS = [4, 4, 4]
_C.MODEL.RESNET.FINAL_CONV_KERNEL = 1
...
_C.MODEL.HRNET.STAGE2.NUM_CHANNELS = [48, 96]
...
_C.MODEL.HRNET.STAGE3.NUM_CHANNELS = [48, 96, 192]
...
_C.MODEL.HRNET.STAGE4.NUM_CHANNELS = [48, 96, 192, 384]
_C.MODEL.HRNET.STAGE4.FUSE_METHOD = "SUM"

# EfficientNet
_C.MODEL.EFFNET = CN()
_C.MODEL.EFFNET.NAME = "efficientnet-b4"
_C.MODEL.EFFNET.SKIP_CONNECT = True
